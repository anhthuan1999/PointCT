...
from util.data_util import data_prepare_stpls3d
...
class STPLS(Dataset):
	def __init__(self, split='train', data_root='trainval', test_area=0, voxel_size=0.04, voxel_max=None, transform=None, shuffle_index=False, loop=1,labeled_point=0.1):
		super().__init__()
	...
	def __getitem__(self, idx):
		...
		coord, feat, label = data_prepare_stpls3d(coord, feat, label, self.split, self.voxel_size, self.voxel_max, self.transform, self.shuffle_index)
